---
title: "Гидрогеохимическая структура потока подземных вод"
date: 2020-06-27
description: "Предыдущая страница Оглавление Следующая страница 2.2.2.3. Гидрогеохимическая структура потока подземных вод &#160;&#160; &#160;&#160;&#160; &#160;&#160;&#160; &#160;Формирование химиче..."
aliases:
  - "/2020/06/gidrogeohimicheskaya-struktura-potoka-podzemnyh-vod.html"
url: "/gidrogeohimicheskaya-struktura-potoka-podzemnyh-vod/"
---

|  |  |  |
| --- | --- | --- |
| [Предыдущая страница](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/gidrogeodinamiceskaa-struktura-potoka-podzemnyh-vod) | [Оглавление](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/tom-ii) | [Следующая страница](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/rezim-i-balans-potokov-podzemnyh-vod-svaz-s-poverhnostnymi-vodami) |

## 2.2.2.3. Гидрогеохимическая структура потока подземных вод

            Формирование химического состава подземных вод основного водоносного горизонта, приуроченного к песчаным отложения кривоборской серии, в естественных условиях подчиняется относительно простым закономерностям взаимодействия атмосферных и речных вод с водовмещающими породами и с донными отложениями. Природные воды (речные и грунтовые) характеризуются повышенными концентрациями железа и марганца.

            На этот сравнительно простой фон накладывается загрязняющее влияние техногенных объектов: ливневых стоков, сбросов недостаточно очищенных промышленных и бытовых стоков.

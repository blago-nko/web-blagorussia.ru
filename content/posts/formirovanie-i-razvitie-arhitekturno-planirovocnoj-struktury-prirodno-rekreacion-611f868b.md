---
title: "Формирование и развитие архитектурно-планировочной структуры природно-рекреационного комплекса города"
date: 2021-01-05
description: "Предыдущая страница Оглавление Следующая страница 5.4.3. Формирование и развитие архитектурно-планировочной структуры природно-рекреационног..."
aliases:
  - "/2021/01/formirovanie-i-razvitie-arhitekturno-planirovocnoj-struktury-prirodno-rekreacionnogo-kompleksa-goroda.html"
url: "/formirovanie-i-razvitie-arhitekturno-planirovocnoj-struktury-prirodno-rekreacionnogo-kompleksa-goroda/"
---

|  |  |  |
| --- | --- | --- |
| [Предыдущая страница](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/shema-osej-ekologiceskogo-karkasa-gorodskogo-okruga-voronez) | [Оглавление](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/tom-ii) | [Следующая страница](http://www.blagorussia.ru/generalnyj-plan-goroda-voronez/analiz-osnovnyh-planirovocnyh-resenij-proekta-generalnogo-plana-s-tocki-zrenia-formirovania-i-razvitia-struktury-prirodno-rekreacionnogo-kompleksa-goroda) |

## 5.4.3. Формирование и развитие архитектурно-планировочной структуры природно-рекреационного комплекса города

При формировании систем озеленения необходимо, чтобы размещение ее объектов было тесно увязано с планировочной структурой города. Общегородские объекты предназначены для массового отдыха жителей всей селитебной территории города, проведения массовых мероприятий. Эти объекты составляют костяк планировочной организационной системы озеленения и являются крупными массивами насаждений.

Каждый элемент системы должен выполнять различные функции: рекреационные, санитарно-гигиенические, микроклиматические, эстетические, природоохранные, градостроительные. Чем больше он функций выполняет, тем выше эффективность системы озеленения города.
